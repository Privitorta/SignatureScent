# Dimmi la tua Signature Scent e ti dirò chi sei
*made with “love”*

### ATTENZIONE
**Sconsiglio <u>vivamente</u> la lettura a chi:**

* ha un ego fragile, debole o similari  
* ha scarsa conoscenza di profumi  
* conosce poco la mia ironia  
* sa cosa vuole dalla vita (quindi non tu se sei qui)  
* ha una mamma o un papà che indossano profumi  
* si offende molto per le critiche  
* si sente sempre preso/a in causa

*Nota:* Se non sai nulla di profumi e ti piacerebbe sapere quale profumo potrebbe diventare la tua signature, ti suggerisco di non leggere questo documento prima di scrivermi; ti posso dare una mano. Poi, dopo che ne troviamo una per te, leggi pure il documento. No hard feelings.
...
Se invece **hai** una signature scent e non la trovi in questo documento, molto probabilmente non l’ho inserita perchè non ho ancora avuto modo di testare il profumo dal vivo. Eccezionalmente, un profumo è assente per ridondanza del giudizio che gli spetterebbe (questi vengono omessi o, al limite, affiancati).
...
### FUNZIONAMENTO
**Una spiegazione breve di come sono strutturate e realizzate le “recensioni”:**
...
\[Brand\] è da chi viene venduto il profumo in questione, \[Nome\] è il nome del profumo.  
\[Foto\] è una foto della boccetta, per evitare fraintendimenti, o dare un’idea a chi non ricorda a memoria i profumi.  
\[Valutazione\] è un voto da 0 a 10 della fragranza senza mezzi termini, un giudizio puramente rivolto al prodotto come tale.  
\[Giudizio\] è il vero giudizio, hopefully, il motivo per cui sei qui. 

Il processo che *precede* la scrittura della mia recensione è facile.   
Immagino davanti a me (in un luogo che possa essere un parco, una discoteca, un bar, un’aula…) una persona con quel profumo addosso e provo a visualizzarne l’estetica, il carattere, la voce, i movimenti, provo a capire quante spruzzate ha fatto, quante angherie ha subito, qualche trauma pregresso… e poi traggo le mie conclusioni in base a quello che sento mentre immagino la scena.
...
**DIOR Fahrenheit**  
![Fahrenheit](images/image129.png)  
*7/10*  
...
![Guilty pour Homme](images/image26.png)  
*2/10*  
...
![L'Homme Ideal](images/image111.png)  
*6/10*  
...
![Terre d'Hermès](images/image88.png)  
*7/10*  
...
$$
\{X \in MuglerAngel \iff BodyCount(X) \in \mathbb{N} : 50 < BodyCount(X) \leq 100\}
$$  
...
![Mon Guerlain](images/image121.png)  
*7/10*  
...
![Shalimar Eau de Parfum](images/image41.png)
![Shalimar L'Essence](images/image76.png)
<br>*9/10*  
...
![Changin Constance](images/image108.png)  
*10/10*  
Andiamo a firmare le carte, tu devi essere mia.

**PRADA Candy**  
![Candy](images/image136.png)  
*8/10*  
